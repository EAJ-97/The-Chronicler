...
export default function RecapViewer({ sessionId, sessionNum, onClose, currentUser, aiEnabled }) {
  ...
  const canGenerate = aiEnabled && usage?.can_generate && !generating;
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '18px 22px', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
          ...
          <button onClick={onClose} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(226,213,187,0.3)', fontSize: '20px' }}>×</button>
        </div>

        {/* Generate controls */}
        {aiEnabled && usage && !loading && (
          <div style={{ padding: '12px 22px', borderBottom: '1px solid rgba(255,255,255,0.04)', display: 'flex', alignItems: 'center', gap: '10px', flexShrink: 0, background: 'rgba(255,255,255,0.01)' }}>
            {/* Tone picker */}
            ...
            {error && (
              <div style={{ fontFamily: 'Crimson Pro, serif', fontSize: '12px', color: 'rgba(220,100,100,0.8)' }}>
                {error}
              </div>
            )}
            ...
            <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
              ...
              {activeRecap && (
                <div style={{ flex: 1, overflowY: 'auto', padding: '28px 32px' }}>
                  ...
                  <div style={{
                    fontFamily: activeRecap.tone === 'chronicle' ? 'Crimson Pro, serif' : 'Crimson Pro, serif',
